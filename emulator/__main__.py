...
if __name__ == '__main__':
    ...
    parser.add_argument("input_data", type=str, help="Path to input data file", default="sys.stdin")
    parser.add_argument("debug", action="store_true", help="Turns on debug mode", default=False)
